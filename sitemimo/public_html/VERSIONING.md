...
Quick reference:
- **2.6.1** (2025-01-29): Otimizações completas - imagens (49.93MB), CLS, render blocking, CSS/JS minificação, acessibilidade
- **2.6.0** (2025-01-29): Mobile UX revamp completo - grid categorias, contraste WCAG AA, footer mobile otimizado, dark mode toggle, touch targets
