...
<body>
                    ...
                    <div class="info-card">
                        ...
                        <form class="contact100-form validate-form" method="POST" action="#form">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Selecione o assunto">
                                <select class="input100" name="subject" required>
                            ...
                            <div class="container-contact100-form-btn">
                                <button class="contact100-form-btn" type="submit" name="submit" id="submit">
                                    <span class="font-weight-bold textDarkGrey" style="letter-spacing: 2px;">ENVIAR MENSAGEM</span>
                                </button>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            // Se a página tem .page-hero, navbar deve ter fundo desde o início
